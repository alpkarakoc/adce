 ...
 * 2^64/T for an idle window T -- 584.5 for a year of 365.25 days, and 213504
 * for a day. The year figure carries its convention because it moves with it:
 * 584.9 at 365 days, 586.6 at 52 weeks. Keep the width; it is cheap and the
 * knob above is meant to be turned.
 * ===========================================================================
 */
